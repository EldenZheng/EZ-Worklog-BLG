...
// weekendSupportBonus counts unique qualifying issues. Seven issues form one
// complete support set worth 300 in the report's base currency.
func weekendSupportBonus(items []WorklogItem) (qualifying, sets int, bonus float64) {
	seen := map[string]bool{}
	...
	sets = qualifying / 7
	return qualifying, sets, float64(sets * 300)
}
